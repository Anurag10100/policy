// Realistic Indian regulatory content for April 2026.
...
// Example chips for the Ask home screen
const EXAMPLE_CHIPS = [
...
// Recent threads (left nav / Threads screen)
const THREADS = [
...
// Citations used by the Answer view (for the "SEBI AIF amendments" question)
const CITATIONS = [
  {
    id: 1,
    regulator: 'SEBI',
  ...
  },
  {
    ...
    excerpt: 'The Private Placement Memorandum of every Category II AIF shall include a dedicated "Dispersion and Redressal" annexure setting out the mechanism for handling dissenting investors where the valuation of unlisted debt instruments diverges by more than 20% across independent valuers.',
    score: 0.88,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    excerpt: 'It is proposed that the minimum commitment for an Accredited Investor into a Category II AIF be reduced from ₹1 crore to ₹25 lakh, subject to the investor meeting the net-worth criterion of ₹7.5 crore or financial assets of ₹5 crore.',
    score: 0.67,
  },
  {
    id: 5,
    ...
    effective: '—',
    type: 'Press Release',
    excerpt: 'The Board approved amendments to the AIF Regulations to introduce a framework for co-investment through a separate vehicle and to recognise differential rights among investors of the same class, in line with recommendations of the Alternative Investment Policy Advisory Committee.',
    score: 0.62,
  },
];

// Corpus browser rows — wider diversity, realistic April 2026 content
const CORPUS_ROWS = [
  {
    ...
    excerpt:'Default Loss Guarantee arrangements between Regulated Entities and Lending Service Providers shall not exceed five percent of the amount of loan portfolio…',
  ...
  },
  {
    ...
    excerpt:'Every scheme of a Category II AIF which has originated or acquired debt securities shall value such holdings…',
    sector:'BFSI', state:'Pan-India',
  },
  {
    ...
    excerpt:'Where provision of group health insurance cover is obligatory for the employer under any law for the time being in force, input tax credit on such insurance shall be available…',
  ...
  },
  {
    ...
    excerpt:'Special surrender value for participating products shall not be lower than the guaranteed surrender value computed as per the methodology in Schedule II…',
    sector:'BFSI', state:'Pan-India',
  },
  {
    ...
    excerpt:'The period for which an ongoing project may continue under sub-rule (1) shall not exceed five financial years, excluding the year in which it was commenced…',
    sector:'Cross-sector', state:'Pan-India',
  },
  {
    ...
    excerpt:'The Authority invites comments on whether OTT communication services should be brought under a light-touch authorisation regime…',
  ...
  },
  {
    ...
    excerpt:'A Consent Manager shall be a company incorporated in India with a net worth of not less than ₹2 crore and shall be registered with the Board…',
    sector:'Cross-sector', state:'Pan-India',
  },
  {
    ...
    excerpt:'Where the benefit or perquisite is provided in kind and the provider is unable to realise TDS in cash, the provider shall ensure tax has been paid by the recipient…',
    sector:'Cross-sector', state:'Pan-India',
  },
  {
    ...
    excerpt:'Battery Energy Storage Systems of capacity not less than 10 MW/40 MWh shall be eligible to participate in the Tertiary Reserve Ancillary Service market…',
  ...
  },
  {
    ...
    excerpt:'The Commission, on examination of evidence, finds that the imposition of wide parity clauses by OP-1 and OP-2 on partner hotels has the effect of restricting intra-brand price competition…',
    sector:'Cross-sector', state:'Pan-India',
  },
  {
    ...
    excerpt:'FDI up to 74% in satellite manufacturing and operation shall be permitted under the automatic route; beyond 74% under Government route…',
    sector:'Cross-sector', state:'Pan-India',
  },
  {
    ...
    excerpt:'The licensing authority may waive the requirement of local clinical trials for new drugs already approved in a specified regulated country, subject to post-marketing surveillance…',
  ...
  },
  {
    ...
    excerpt:'The aggregate exposure of a lender across all P2P platforms to a single borrower shall not exceed ₹50,000 at any point in time…',
    sector:'BFSI', state:'Pan-India',
  },
  {
    ...
    excerpt:'A Point of Presence may, with prior intimation to the Authority, engage any banking correspondent registered with the Reserve Bank of India as a sub-entity for on-boarding subscribers…',
    sector:'BFSI', state:'Pan-India',
  },
];
